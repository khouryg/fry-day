...
- Start a session while forecast UV is positive; allow Live Activities if desired. No notification permission prompt should appear.
...
- Upgrade from build 1 with a reminder pending; verify it is canceled and no new notification is scheduled.
